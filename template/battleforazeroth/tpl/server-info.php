        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="bfa-card" style="padding: 34px 25px">
                    <div class="icon">
                        <img src="<?php echo $antiXss->xss_clean(get_config("cdnurl")); ?>/template/<?php echo $antiXss->xss_clean(get_config("template")); ?>/img/card-1.png" alt="">
                    </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="bfa-card">
                    <div class="icon">
                        <img src="<?php echo $antiXss->xss_clean(get_config("cdnurl")); ?>/template/<?php echo $antiXss->xss_clean(get_config("template")); ?>/img/card-2.png" alt="">
                    </div>
