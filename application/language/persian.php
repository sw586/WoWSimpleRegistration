...
$language['custom_css'] = '@font-face {font-family: vazir;src: url(\''.get_config('cdnurl').'/template/languages/persian/fonts/Vazir-Light-FD.eot\');src: url(\''.get_config('cdnurl').'/template/languages/persian/fonts/Vazir-Light-FD.eot?#iefix\') format(\'FontName-opentype\'),url(\''.get_config('cdnurl').'/template/languages/persian/fonts/Vazir-Light-FD.woff\') format(\'woff\'),url(\''.get_config('cdnurl').'/template/languages/persian/fonts/Vazir-Light-FD.ttf\') format(\'truetype\');font-weight: normal; font-style: normal;}*, h1, h2, h3, h4, h5, h6, .nav-menu a, a{ font-family: vazir;direction: rtl;} .modal-header .close {padding: 1rem 1rem;margin: -1rem auto -1rem -1rem;} .alert { text-align: right;}.content_box1{ text-align: right;}';
